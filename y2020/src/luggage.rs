...
impl Rules {
    ...
    pub fn find_num_containers(&self, target: &Bag) -> usize {
        self.index.keys()
            .into_iter()
    ...
    fn find_recursive(&self, target: &Bag, current: &Bag) -> usize {
...
dark violet bags contain no other bags.";
    ...
    #[test]
    fn day7() {
        let raw_input = "dull silver bags contain 2 striped magenta bags, 2 dark coral bags, 1 bright orange bag, 4 plaid blue bags.
